...
const file = path.join(config.appRoot, "./www/index.html");

// Bundler options
const options = {
  outDir: config.deployRoot, // The out directory to put the build files in, defaults to dist
  outFile: path.join(config.deployRoot, "index.html"), // The name of the outputFile
